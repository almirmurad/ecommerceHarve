...
function Carrinho() {
  const { listarProdutosCarrinho, removerProduto } = useContext(CarrinhoContext);
  const [produtosCarrinho, setProdutosCarrinho] = useState([]);

  useEffect(() => {
    console.log("BUSCAR CAAAR", listarProdutosCarrinho);
    if (listarProdutosCarrinho) {
      setProdutosCarrinho(listarProdutosCarrinho);
    }
  }, [listarProdutosCarrinho]);
  console.log("Aqui",produtosCarrinho);
